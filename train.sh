...
python imitate_episodes.py --task_name ${task_name} --ckpt_dir check_point/${task_name} --policy_class ACT --kl_weight 10 --chunk_size 100 --hidden_dim 512 --batch_size 128 --dim_feedforward 3200 --num_steps 5000  --lr 1e-5 --temporal_agg --seed 0
