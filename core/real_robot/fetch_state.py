...
prepare_conf = {
    ...
    'open_fridge_upper': {
        'position': [-4.0099982738432, 3.653033861191444, 0.0],
        'orientation': [0.0, 0.0, 0.8873504521141168, 0.4610956247166877],
        'arm_joints': [0.07189165840454101, 1.0210223718383789, -2.07426778583374, 2.1159947564453123, 
                       1.7553699439804078, -1.161670629812622, 2.169129759130249],
        'torso': 0.37,
        'head': [0.06139826774597168, -0.009649870782470702],
        'back_before_arm': False,
        'back_and_forth_duration': [0.2, 0],
        'max_len': 550,
        'speed': 2.5
